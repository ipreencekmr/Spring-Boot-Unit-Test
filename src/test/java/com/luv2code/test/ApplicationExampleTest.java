...
public class ApplicationExampleTest {
    ...
    public void beforeEach() {
        ...
        student.setEmailAddress("ipreencekmr@gmail.com");
    ...
    void createStudentWithoutGradesInit() {
        ...
        studentTwo.setFirstname("Rohit");
        studentTwo.setLastname("Sharma");
        studentTwo.setEmailAddress("rohit.sharma@outlook.com");
